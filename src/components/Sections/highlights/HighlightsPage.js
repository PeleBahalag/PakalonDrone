...
const HighlightsPage = () => {
  ...
  const TEXT_BEFORE2 = {
    ...
    4: "דיווח על המראה ונחיתה לגורמים הנמצאים באזור",
  };
  ...
  const TEXT_DURING1 = {
    ...
    4: "לפני ההמראה יש לוודא את הדברים הבאים: 4 גומיות תקינות ובמקום, סוללות טעונות בכל האמצעים, כרטיס זיכרון ריק מתוכן, פרופלורים תקינים.",
  ...
  const TEXT_AFTER1 = {
    ...
    1: 'אין לעדכן גרסה באפליקציה, זו אחריות החברה בלבד, ע״י מש"א 7000',
    2: "במידה והרחפן התרסק או נפל לא נטיס אותו עד שיעבור בדיקה מקיפה (ע״י טכנאי בבסיס שעבר הכשרה/ ע״י מש״א).",
    3: 'בסיום כל פעילות נמלא דו"ח טיסה.',
    4: "יש להימנע מאחסון סוללות במכולות, רכבים או כל אמצעי אחסון היכול להגיע לטמפרטורה הגבוהה מ40 מעלות, סוללה חמה לאחר פעילות לא תיטען- יש להניח לה להתקרר מעט.",
